        ...
        <section>
            <div className="max-w-4xl mx-auto space-y-8">
                ...
                <Card className="bg-neutral-800 border-neutral-700">
                    <CardHeader>
                        <CardTitle className="text-yellowClr">Profile Picture</CardTitle>
                    </CardHeader>
                    <CardContent className="flex items-center gap-6">
                        <div className="relative h-28 w-28 rounded-full overflow-hidden border-2 border-yellowClr">
                            <Image
                ...
                <Card className="bg-neutral-800 border-neutral-700">
                    <CardHeader>
                        <CardTitle className="text-yellowClr">Profile Information</CardTitle>
                    </CardHeader>
                        ...
                        <form onSubmit={handleProfileUpdate} className="space-y-6">
                            ...
                            <div className="grid md:grid-cols-2 gap-4">
                                <div className="space-y-1">
                                    <Label className={'text-gray-300 font-normal'}>Name</Label>
                                    <Input
                                        value={formData.fullName}
                                        onChange={(e) =>
                                            setFormData({ ...formData, fullName: e.target.value })
                                        }
                                        className="bg-transparent text-white border-neutral-600"
                                    />
                                </div>

                                <div className="space-y-1">
                                    <Label className={'text-gray-300 font-normal'}>Email</Label>
                                    <Input
                                        value={formData.email}
                                        disabled
                                        className="bg-transparent text-white opacity-70  border-neutral-600"
                                    />
                                </div>

                                <div className="space-y-1">
                                    <Label className={'text-gray-300 font-normal'}>Mobile</Label>
                                    <Input
                            ...
                            {user?.role === "vendor"
                                ? <div className="grid md:grid-cols-2 gap-4">
                                    <div className="space-y-1">
                                        <Label className={'text-gray-300 font-normal'}>Company Name</Label>
                                        <Input
                                    ...
                                    <div className="space-y-1">
                                        <Label className={'text-gray-300 font-normal'}>Company Address</Label>
                                        <Input
                                    ...
                                    <div className="space-y-1">
                                        <Label className={'text-gray-300 font-normal'}>GST</Label>
                                        <Input
                                            value={formData.gst}
                                            onChange={(e) =>
                                ...
                                : user?.role === "driver"
                                    ? <div className="grid md:grid-cols-2 gap-4">
                                        <div className="space-y-1">
                                            <Label className={'text-gray-300 font-normal'}>License Number</Label>
                                            <Input
                                        ...
                                        <div className="space-y-1">
                                            <Label className={'text-gray-300 font-normal'}>Aadhar Number</Label>
                                            <Input
                                    ...
                                    : user?.role === "user"
                                        ? <div className="grid md:grid-cols-2 gap-4">
                                            <div className="space-y-1">
                                                <Label className={'text-gray-300 font-normal'}>Profession</Label>
                                                <Input
                            ...
                            <Button
                                type="submit"
                                disabled={loading}
                                className="bg-yellowClr text-black hover:bg-yellowClr/90"
                            >
