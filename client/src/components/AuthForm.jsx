...
// // import { forgotPassword, loginUser, registerUser, resendEmailOtp, resetPassword, verifyEmail } from '@/api/userController'
...
//     })
//     const inputs = useRef([])
//     // const { fetchUser, fetchInterestsSent } = useAuth()
...
//         //         if (otp.length < 6) {
//         //             toast.error("Please enter a valid OTP", { duration: 3000 })
//         //             return
//         //         }
...
//                                 <div className={`grid ${type === 'SignUp' && 'sm:grid-cols-2'} gap-2`}>
//                                     <div className="grid gap-2">
...
//                                     <RadioGroup defaultValue="company" className={'col-span-2 flex flex-1'} onValueChange={(value) => setRegisterType(value)}>
...
//                                                 />
//                                                 {pinCodeLoading && (
//                                                     <div class="absolute top-[29px] right-2 animate-spin rounded-full h-5 w-5 border-3 border-orangeClr border-t-transparent"></div>
//                                                 )}
//                                             </div>
...
//                                         </> : <>
//                                             <div className="grid gap-2 sm:col-span-2">
//                                                 <Label htmlFor="profession">Driving License</Label>
//                                                 <Input
//                                                     id="profession"
//                                                     type="file"
//                                                     name="profession"
...
//                                             </div>
//                                             <div className="grid gap-2 sm:col-span-2">
//                                                 <Label htmlFor="state">Identity Card</Label>
//                                                 <Input
//                                                     id="state"
//                                                     type="file"
//                                                     name="state"
...
//                             )}
//                             {(type === 'SignIn' || type === 'SignUp' || type === 'Reset') && (<div className="grid gap-2 relative">
...
//                                     size={'icon'}
//                                     variant={'ghost'}
//                                     className={`absolute right-0 ${type === 'SignIn' ? 'top-[23px]' : 'top-[21px]'} hover: bg-transparent cursor-pointer`}
//                                     onClick={() => setShowPassword(!showPassword)}
//                                 >
//                                     {showPassword ? <EyeClosed size={16} aria-hidden="true" /> : <Eye size={16} aria-hidden="true" />}
//                                 </Button>
//                             </div>)}
//                             {type === 'Reset' && (
//                                 <div className="grid gap-2 relative">
...
//                                     >
//                                         {showConfirmPassword ? <EyeClosed size={16} aria-hidden="true" /> : <Eye size={16} aria-hidden="true" />}
//                                     </Button>
//                                 </div>
//                             )}
//                             {type === 'SignUp' && (
...
//                             {type === 'SignUp' && (
//                                 <div className="flex items-center gap-2">
//                                     <input type="checkbox" id="terms" className="accent-orangeClr" required />
...
//                             {type === 'Verify' && (
//                                 <div>
//                                     <div onPaste={handlePaste} className="flex justify-between gap-2 mb-2">
...
//                                         </p>
//                                     ) : (
//                                         <button type="button" onClick={handleResendOTP} className="w-full text-sm cursor-pointer font-semibold text-orangeClr">
//                                             Resend OTP
//                                         </button>
//                                     )}
//                                 </div>
...
//                             </div>
//                             <Link
//                                 href={type === 'SignIn' ? '/sign-up' : type === 'SignUp' ? '/sign-in' : '/sign-in'}
//                                 className="underline underline-offset-4"
//                             >
//                                 {type === 'SignIn' ? 'Sign Up' : type === 'SignUp' ? 'Sign In' : 'Sign In'}
//                                 {loading && type === 'SignIn' ? '...' : '...'}
//                             </Link>
//                         </div>
//                     </div>
...
export default function AuthForm({ className, type, ...props }) {
  ...
  const demoSendMobileOtp = async (mobile) => {
    await fakeDelay();
    sessionStorage.setItem("mobile", mobile);
    return { status: "success", message: "OTP sent to your mobile" };
  };

  const demoVerifyMobileOtp = async () => {
    await fakeDelay();
    return { status: "success" };
  };
  ...
  const handleSubmit = async (e) => {
    ...
    if (type === "SignInOtp") {
      try {
        ...
        const res = IS_DEMO
          ? await demoSendMobileOtp(mobile)
        ...
        <div className="w-full max-w-md">
          ...
          >
            ...
            <div className="grid sm:gap-4 gap-3">
              ...
              {type === "SignIn" && (
                <Link href="/sign-in-otp" className="text-xs underline">
                  Login with Mobile OTP
                </Link>
              )}
