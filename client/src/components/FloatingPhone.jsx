    ...
    >
      ...
      >
        ...
        <div className="relative flex items-center justify-center">
          ...
          {/* Button */}
          <div className="relative bg-yellowClr text-black p-4 rounded-full shadow-2xl hover:scale-110 active:scale-95 transition-transform">
            <motion.div
              animate={{
        ...
        <div className="bg-yellowClr hover:bg-yellow-400 transition-colors text-neutral-900 px-5 py-2 rounded-full font-medium flex items-center gap-2 text-sm">
